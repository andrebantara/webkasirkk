...
// Set query default untuk menampilkan semua produk
        ...
        function confirmDelete(produkID) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "hapus.php?id=" + produkID;
                }
            });
        }
    </script>
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-8 ml-64">
            ...
            <div class="flex justify-between">
                ...
                <a href="tambah.php" class="bg-sky-800 text-white font-bold font-sans py-2 px-2 rounded-sm">Tambah Barang</a>
            </div>
                        ...
                        <?php foreach ($row as $item): ?>
                            <tr class="border-b border-gray-200 hover:bg-blue-50">
                                ...
                                <td class="p-4 text-gray-700">
                                        <?= $item['Stok']; ?>
                                        <?php if ($item['Stok'] < 10): ?>
                                            <i class="fas fa-arrow-down text-red-600 ml-2" title="Stok rendah"></i>
                                        <?php endif; ?>
                                </td>

                                <td class="p-4 text-gray-700 flex justify-around">
                                    <a href="edit.php?id=<?= $item["ProdukID"] ?>" class="bg-yellow-300 px-2 py-1 rounded-sm hover:bg-yellow-400"><i class="fa-solid fa-pen"></i></a>
