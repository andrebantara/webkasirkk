<nav class="bg-gray-600 shadow-md h-screen fixed top-0 left-0 w-64">
            ...
            <div class="px-4 space-y-4">
                ...
                <a href="barang/databarang.php" class="block text-gray-50 hover:text-blue-500 transition duration-200">Data Produk</a>
                <a href="penjualan/laporanpenjualan.php" class="block text-gray-50 hover:text-blue-500 transition duration-200">Laporan Penjualan</a>
            ...
            <div class="absolute flex flex-col bottom-0 px-4 mb-4 space-y-2">
                ...
                <a href="../../auth/loginpetugas/logout.php" id="log-out" class="text-gray-50 hover:text-blue-500 transition duration-200">
