<nav class="bg-gray-600 shadow-md h-screen fixed top-0 left-0 w-64">
            ...
            <div class="px-4 space-y-4">
                <a href="../../petugas/index.php" class="block text-gray-50 hover:text-blue-500 transition duration-200">Home</a>
                <a href="databarang.php" class="block text-gray-50 hover:text-blue-500 transition duration-200">Data Barang</a>
                <a href="/" class="block text-gray-50 hover:text-blue-500 transition duration-200">Pembeli</a>
                <a href="#about" class="block text-gray-50 hover:text-blue-500 transition duration-200">Tentang Kami</a>
            </div>
